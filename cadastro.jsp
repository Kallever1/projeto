<%-- 
    Document   : cadastro1
    Created on : 01/03/2018, 20:42:51
    Author     : Ivani
--%>
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <div class="top-row">
            ...
            <label>
              Data de Nascimento<span class="req">*</span>
                ...
                <input type="date" name="dt_nascimento" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="number" name="rg" required autocomplete="off"/>
          </div>
            ...
            <input type="text" required autocomplete="off"/>
              ...
              <button type="submit" class="button button-block"/>Cadaste-se</button>
